...
#  - Markdown
image:
  caption: 'Image credit: [**CIn-UFPE**]([https://unsplash.com](https://portal.cin.ufpe.br/))'
---
...
The paper was co-authored by Professors [Francisco de Assis Tenório de Carvalho](https://www.cin.ufpe.br/~fatc/) (CIn-UFPE) and [Marcelo Rodrigo Portela Ferreira](https://sigaa.ufpb.br/sigaa/public/docente/portal.jsf?siape=1584539) (DE-UFPB) and proposes a novel co-clustering algorithm for the fuzzy clustering approach. This model enables the simultaneous grouping of objects and variables, establishing relationships between subsets that contain similar elements. The method, based on the Gaussian kernel function, employs an automatic weighting scheme that reduces the impact of noisy data, making it particularly useful in areas such as healthcare, text mining, and content recommendation.

Organized by the *[Institute of Electrical and Electronics Engineers (IEEE)](https://www.ieee.org/)*, the conference highlights the excellence and quality of the research conducted at CIn. According to José Nataniel, the academic environment provided by the Center, along with financial support and the guidance of Professor Francisco de Carvalho, was essential to achieving the high-quality results obtained in the development of the paper. Congratulations to the authors!
